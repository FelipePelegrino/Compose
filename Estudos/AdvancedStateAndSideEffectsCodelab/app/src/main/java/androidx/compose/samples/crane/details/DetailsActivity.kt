...
fun DetailsScreen(
    ...
    /*
    * Se por algum motivo (que eu ainda não sei qual) quiser mapear estados que não são um
    * State de Composable necessariamente, porém fazer isso no Composable, utilizamos produceState
    * Ele retorna um State, com base no initialValue/callback producer
    * */

...
/*
* snapshotFlow literalmente tira uma foto do State, converte para um Flow, e toda vez que o
* state mudar seu valor, será emitido um novo valor no flow. Dessa forma, podemos ainda mander um
* tracking do state e fazer alterações que a API de flow nos permite, como filter e collect.
* */
@Composable
